					...
					<div class="panel panel-default">
						...
						<div id="user-info-collapse2" class="panel-collapse collapse <?php if($payment_status==0 && $transaction_status==0){ ?>in<?php }?>">
							<div class="panel-body">
								...
								<ol type="1">
									<li>Go to your UPI-APP and Select ‘<b>AITM</b>’ then ‘<b>Pay Bill</b>’ option</li>
									<li>Enter UPI-ID. <b>your paybill</b></li>
									<li>Enter <b><?php echo $transaction_code; ?></b> as Account No.</li>
									<li>Enter the Amount INR <b><?php echo $this->qm->formatMoney($transaction_total,true); ?></b>.</li>
									<li>Enter your  PIN and Send.</li>
									<li>Input the transaction code in the input below and submit to confirm your payments.</li>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="form-group has-placeholder">
										...
										<input class="form-control" type="text" name="UPI-transaction" placeholder="Transaction Code" value="" id="UPI-transaction" required="required">
									</div>
								</div>
							</div>
							<div class="row"></div>
